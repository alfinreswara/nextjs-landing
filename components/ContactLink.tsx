        ...
        {isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            >
              ...
              <div className="mt-8 rounded-xl border border-border bg-background p-1.5 flex items-center justify-between">
                ...
                <a
                  ...
                  onClick={() => setIsOpen(false)}
                  className="inline-flex items-center gap-1.5 rounded-lg bg-accent px-4 py-2.5 text-xs font-semibold text-[var(--btn-accent-text)] transition hover:opacity-90 hover:scale-105 active:scale-95 duration-200"
                >
